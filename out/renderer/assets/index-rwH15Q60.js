...
function injectCSS$1(css) {
  ...
  if (prepend) {
    if (isPrependQueue) {
      var existStyle = findStyles$1(container).filter(function(node) {
...
function findExistNode$1(key) {
  var option = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
  var container = getContainer$1(option);
  return findStyles$1(container).find(function(node) {
...
var Icon$2 = /* @__PURE__ */ reactExports.forwardRef(function(props, ref2) {
  var _classNames;
...
const FullscreenExitOutlined$1 = /* @__PURE__ */ reactExports.forwardRef(FullscreenExitOutlined);
...
var FullscreenOutlined = function FullscreenOutlined2(props, ref2) {
  return /* @__PURE__ */ reactExports.createElement(AntdIcon, _extends({}, props, {
    ref: ref2,
    icon: FullscreenOutlinedSvg
  }));
};
const FullscreenOutlined$1 = /* @__PURE__ */ reactExports.forwardRef(FullscreenOutlined);
...
var MenuOutlined = function MenuOutlined2(props, ref2) {
  return /* @__PURE__ */ reactExports.createElement(AntdIcon, _extends({}, props, {
    ref: ref2,
...
var PlusOutlined = function PlusOutlined2(props, ref2) {
  return /* @__PURE__ */ reactExports.createElement(AntdIcon, _extends({}, props, {
    ref: ref2,
...
function useComposeRef() {
  ...
  return (0, _useMemo.default)(function() {
    ...
    return prev.length !== next.length || prev.every(function(ref2, i) {
      return ref2 !== next[i];
    });
  });
}
...
var _canUseDom = _interopRequireDefault(canUseDom$1);
var _contains = _interopRequireDefault(contains$1);
...
(function(exports) {
  ...
  _export(exports, {
    ...
    isIconDefinition: function() {
      return isIconDefinition2;
    },
    normalizeAttrs: function() {
      return normalizeAttrs2;
    },
    generate: function() {
      return generate2;
    },
    getSecondaryColor: function() {
      return getSecondaryColor2;
    },
    normalizeTwoToneColors: function() {
      return normalizeTwoToneColors2;
    },
    ...
    useInsertStyles: function() {
      return useInsertStyles3;
    }
  });
  var _colors = require$$0;
  var _dynamicCSS = dynamicCSS;
  var _shadow = shadow;
  var _warning = /* @__PURE__ */ _interop_require_default(warning$1);
  var _react2 = /* @__PURE__ */ _interop_require_wildcard(reactExports);
  var _Context = /* @__PURE__ */ _interop_require_default(Context);
  ...
  function generate2(node, key, rootProps) {
    if (!rootProps) {
      return _react2.default.createElement(node.tag, _object_spread({
        key
...
(function(exports) {
  ...
  var Icon2 = /* @__PURE__ */ _react2.forwardRef(function(props, ref2) {
    ...
    var iconRef = _react2.useRef();
    var mergedRef = (0, _ref.useComposeRef)(iconRef, ref2);
    (0, _utils.warning)(Boolean(Component || children), "Should have `component` prop or `children`.");
    (0, _utils.useInsertStyles)(iconRef);
    var _React_useContext = _react2.useContext(_Context.default), _React_useContext_prefixCls = _React_useContext.prefixCls, prefixCls = _React_useContext_prefixCls === void 0 ? "anticon" : _React_useContext_prefixCls, rootClassName = _React_useContext.rootClassName;
    ...
    var renderInnerNode = function() {
      if (Component) {
        return /* @__PURE__ */ _react2.createElement(Component, innerSvgProps, children);
      }
      if (children) {
        (0, _utils.warning)(Boolean(viewBox) || _react2.Children.count(children) === 1 && /* @__PURE__ */ _react2.isValidElement(children) && _react2.Children.only(children).type === "use", "Make sure that you provide correct `viewBox` prop (default `0 0 1024 1024`) to the icon.");
        return /* @__PURE__ */ _react2.createElement("svg", _object_spread_props(_object_spread({}, innerSvgProps), {
          viewBox
        }), children);
      }
      return null;
    ...
    return /* @__PURE__ */ _react2.createElement("span", _object_spread_props(_object_spread({
      role: "img"
    }, restProps), {
      ref: mergedRef,
      tabIndex: iconTabIndex,
...
const Icon = /* @__PURE__ */ getDefaultExportFromCjs(Icon$1);
const Ding = () => /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { viewBox: "0 0 1024 1024", width: "10", height: "10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
  "path",
  {
    d: "M874.826587 612.557721c-10.746627-96.207896-59.362319-183.716142-134.588706-244.101949V135.10045h8.69965c37.357321 0 67.550225-30.192904 67.550225-67.550225S786.294853 0 748.937531 0H282.738631C245.381309 0 215.188406 30.192904 215.188406 67.550225s30.192904 67.550225 67.550225 67.550225h1.023488v233.867066c-10.746627 8.187906-20.469765 17.3993-30.192904 27.122439-58.850575 58.338831-95.696152 134.588706-104.395802 216.97951v4.093953c0 19.958021 16.375812 36.845577 36.333833 36.845578h261.50125v304.9995c0 35.822089 29.169415 64.991504 64.991504 64.991504 35.822089 0 64.991504-29.169415 64.991504-64.991504v-304.9995h261.50125c9.723138 0 18.934533-4.093953 25.587206-10.746627 8.187906-8.69965 12.281859-19.446277 10.746627-30.704648z",
    "p-id": "2867"
  }
) });
const Minimize = () => /* @__PURE__ */ jsxRuntimeExports.jsx(
  "svg",
  {
...
const Maximize = () => /* @__PURE__ */ jsxRuntimeExports.jsx(
  "svg",
  {
    ...
    width: "14",
    height: "14",
    children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M960 554.666667H106.666667a21.333333 21.333333 0 0 1 0-42.666667h853.333333a21.333333 21.333333 0 0 1 0 42.666667z" })
  }
);
const Close = () => /* @__PURE__ */ jsxRuntimeExports.jsx(
  "svg",
  {
    viewBox: "0 0 1024 1024",
    version: "1.1",
...
const DingIcon = (props) => /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { component: Ding, ...props });
const MinimizeIcon = (props) => /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { component: Maximize, ...props });
...
function Menu({ isMac }) {
  const [leftPanelWidth, setLeftPanelWidth] = reactExports.useState(200);
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "nav",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(CommonMenu, {})
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
